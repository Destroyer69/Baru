...
<div class="tambah-data" style="display:none; width:400px; height:185px; border:1px solid black;">
...
<table class="table">
	...
	$a = mysql_query("SELECT A.id_produk, A.nama_produk, B.nama_kategori, A.harga, A.foto, A.keterangan FROM produk AS A INNER JOIN kategori AS B ON (A.id_kategori = B.id_kategori) WHERE A.id_produk LIKE '%$katakunci%' OR A.nama_produk LIKE '%$katakunci%' ORDER BY A.id_produk ASC LIMIT $start, $data");
